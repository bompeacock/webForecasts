...
<body>
	...
	<div class="site-content">
		<div class="site-header" data-bg-image="images/header.jpg">
			<div class="container">
				<a href="index.jsp" class="branding"> <img src="images/logo.png"
					alt="" class="logo">
					<div class="logo-type">
		...
		<!-- .site-header -->
			...
			<div class="hero" >
				<div class="container">
					<form action="Location" method="get" class="find-location"  id="find-location" name="find-location">
						<input type="text" placeholder="Find your location..." name="location">
						<input type="submit" value="Find" onclick="return find()">
						</form>
			</div>
			...
			<div class="hero1" >
				<div class="container">
						<div >
								...
								<a href="weatherLocation.html"><button class="btn"><p style="background: url(images/location.png);height:64px;width:64px;"></p></button></a>
						</div>
				</div>
			</div>
